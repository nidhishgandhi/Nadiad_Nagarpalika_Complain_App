...
class Drainage extends StatefulWidget {
  @override
  _DrainageState createState() => _DrainageState();
}

class _DrainageState extends State<Drainage> {
  String myName;
  String myMob;
  String myPin;
  String myAddress;
  ...
  CollectionReference ref = FirebaseFirestore.instance.collection('Drainage');

  String valuechoose;

  // List listitems = [
  //   "Drain Blockage",
  //   "Drainage Line Breakage",
  ...
  Future showNotificattion() async {
    ...
    await localNotification.show(
        ...
        "Your Drainage Complain has been successfully registered. ",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Drainage Complain Form'),
      ),

...
class Sanitization extends StatefulWidget {
  @override
  _SanitizationState createState() => _SanitizationState();
}

class _SanitizationState extends State<Sanitization> {
  String myName;
  String myMob;
  String myPin;
  String myAddress;
  ...
  CollectionReference ref =
      FirebaseFirestore.instance.collection('Sanitization');

  String valuechoose;

  // List listitems = [
  //   "Sanitization irregularity",
  //   "Unsafe Sanitization",
  //   "Hand Sanitizers unavailability",
  //   "Others"
  // ];
  ...
  Future showNotificattion() async {
    ...
    await localNotification.show(
        ...
        "Your Sanitization Complain has been successfully registered. ",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Sanitization Complain Form'),
      ),

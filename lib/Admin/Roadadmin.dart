...
class RoadAdmin extends StatefulWidget {
  @override
  _RoadAdminState createState() => _RoadAdminState();
}

class _RoadAdminState extends State<RoadAdmin> {
  CollectionReference ref = FirebaseFirestore.instance.collection('RoadAdmin');
  bool flag = false;

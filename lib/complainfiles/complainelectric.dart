...
class ViewComplainsElectric extends StatefulWidget {
  @override
  _ViewComplainsElectricState createState() => _ViewComplainsElectricState();
}

class _ViewComplainsElectricState extends State<ViewComplainsElectric> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Your Electricity Complains"),
      ),
      body: StreamBuilder(
          stream: ref
